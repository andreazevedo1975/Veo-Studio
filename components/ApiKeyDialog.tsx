  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-xl max-w-lg w-full p-8 text-center flex flex-col items-center">
        ...
        <h2 className="text-3xl font-bold text-white mb-4">Chave de API Paga Necessária</h2>
        <p className="text-gray-300 mb-6">
          O Veo é um modelo de geração de vídeo exclusivamente pago. Para usar este recurso, selecione uma chave de API associada a um projeto do Google Cloud com faturamento ativado.
        </p>
        ...
        >
          Continuar para Selecionar Chave
        </button>
      </div>
    </div>
  );
